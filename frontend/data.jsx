...
const RIGHTS_HOLDERS = [
  'BCCI Media Group', 'Premier Football League', 'NBA Broadcasting Inc.',
  'ATP Media Services', 'F1 Rights Holdings',
];
const SAMPLE_ASSETS = [
...
window.SG_DATA = { SPORTS, RIGHTS_HOLDERS, SAMPLE_ASSETS, SAMPLE_DETECTIONS, PIPELINE_STEPS };
